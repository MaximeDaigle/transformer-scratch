...
# Used this code to test my implementation of:
#      - GRU recurrent unit
#      - Multi-head attention for the Transformer

# ## Experiments configuration:
#    - Experiment 3.1, hyperparameter settings
...
#    - Experiment 3.2, hyperparameter settings
...
#    - Experiment 3.3, hyperparameter settings
...
#    - Experiment 3.4, hyperparameter settings
...
# - Experiment 4.1 performs all computations / plots based on saved models from
#   Experiment 3.1 and 3.2. Note the --save_best flag
...
m_flat_lr = 14.0 # not touch lr for the first m_flat_lr epochs
